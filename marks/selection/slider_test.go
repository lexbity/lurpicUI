...
func highContrastTokens() theme.Tokens {
	...
	tokens.Color.Background = colorToGfx(color.RGBA{R: 0, G: 0, B: 0, A: 255})
	tokens.Color.Surface = colorToGfx(color.RGBA{R: 0, G: 0, B: 0, A: 255})
	tokens.Color.SurfaceVariant = colorToGfx(color.RGBA{R: 32, G: 32, B: 32, A: 255})
	tokens.Color.OnBackground = colorToGfx(color.RGBA{R: 255, G: 255, B: 255, A: 255})
	tokens.Color.OnSurface = colorToGfx(color.RGBA{R: 255, G: 255, B: 255, A: 255})
	tokens.Color.OnSurfaceVariant = colorToGfx(color.RGBA{R: 255, G: 255, B: 255, A: 255})
	tokens.Color.Primary = colorToGfx(color.RGBA{R: 255, G: 255, B: 0, A: 255})
	tokens.Color.OnPrimary = colorToGfx(color.RGBA{R: 0, G: 0, B: 0, A: 255})
	tokens.Color.DisabledOpacity = 0.7
	tokens.Color.HoverLighten = 0.22
	tokens.Color.PressedDarken = 0.12
	tokens.Color.SelectedOverlay = 0.18
	return tokens
}
