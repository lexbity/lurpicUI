...
func TestHashutil_all_command_helpers_are_covered(t *testing.T) {
	...
	cl := gfx.CommandList{Commands: []gfx.Command{
		...
		gfx.DrawPolyline{Points: []gfx.Point{{X: 1, Y: 1}, {X: 2, Y: 3}, {X: 4, Y: 5}}, Stroke: gfx.StrokeStyle{Width: 1, Cap: gfx.LineCapButt, Join: gfx.LineJoinMiter, MiterLimit: 10, Dash: []float32{1}, DashOffset: 0.5}, Brush: gfx.SolidBrush(gfx.Color{R: 1, A: 1}), Closed: true},
		gfx.DrawPoints{Points: []gfx.Point{{X: 6, Y: 7}, {X: 8, Y: 9}}, Radius: 2, Brush: gradient},
