...
func (c Constraints) toFacet() facet.Constraints {
...
func fromFacetConstraints(c facet.Constraints) Constraints {
	return Constraints{
		MinSize: c.MinSize,
		MaxSize: c.MaxSize,
	}
...
func clampSize(size gfx.Size, minSize, maxSize gfx.Size) gfx.Size {
	return gfx.Size{
		W: clampAxis(size.W, minSize.W, maxSize.W),
		H: clampAxis(size.H, minSize.H, maxSize.H),
	}
}
